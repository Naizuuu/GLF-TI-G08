...
<form id="form" method="GET" autocomplete="off" style="display: none;" action="{{route('hoja_de_ruta')}}">
    <div class="containerParametros">   
        ...
        <p class="text-center lead">Use el archivo de parámetros para continuar, recuerde que debe tener el formato correcto.</p>
        <textarea id="contenido_parametros" name="contenido_parametros" rows="4" cols="30" style="width:500px; height:300px; resize: none;" title="El formato del contenido debe tener la siguiente estructura: T;N;X,Y" disabled></textarea>
        <input id="file_parametros" class="" enctype="multipart/form-data" type="file" accept=".txt" style="margin-top: 2%;" required>
    </div>
    <button type="submit" style="margin-bottom: 3%;" class="btn btn-lg btn-block custom-btn">Confirmar</button>
</form>
